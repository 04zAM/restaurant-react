              ...
              <div className="flex flex-col justify-start w-full">
                ...
                >
                  <div className="flex flex-col gap-[26px] items-start justify-start md:ml-[0] ml-[19px] mt-[54px] w-[61%] md:w-full">
                    <Text
                      className="font-semibold leading-[110.00%] text-left text-white_A700 w-full"
                      as="h4"
                      variant="h4"
                    >
                ...
                <div className="flex md:flex-col flex-row font-poppins md:gap-5 items-center justify-start md:ml-[0] ml-[34px] mt-12 w-[95%] md:w-full">
                  ...
                  <div className="flex flex-col gap-[30px] items-center justify-start ml-28 md:ml-[0] w-[24%] md:w-full">
                    <Button
                      className="cursor-pointer font-normal min-w-[246px] not-italic text-center text-white_A700 text-xl w-auto"
                    ...
                    <Button
                      className="common-pointer cursor-pointer font-normal min-w-[246px] not-italic text-center text-gray_900 text-xl w-auto"
