        ...
        <div className="flex flex-col items-center justify-start max-w-[1112px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-[120px] w-full">
            <Img
              ...
              className="md:flex-1 h-[629px] sm:h-auto object-cover w-auto md:w-full"
              alt="unsplashlRAWcT"
            />
            <div className="flex md:flex-1 flex-col md:gap-10 gap-[60px] items-start justify-start w-auto md:w-full">
              <div className="flex flex-col gap-4 items-start justify-start w-full">
                <Text
                  className="font-tinos leading-[140.00%] text-gray_900 text-left w-full"
                  as="h3"
                  variant="h3"
                ></Text>
                <Text
              ...
              <div className="flex flex-col items-start justify-start w-auto md:w-full">
                ...
                <Text
                  className="font-light font-poppins italic leading-[200.00%] text-gray_801 text-left w-full"
                  as="h6"
                  variant="h6"
                >
