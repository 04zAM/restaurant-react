    ...
    <>
      <div className="bg-gray_50 flex flex-col font-poppins items-center justify-start mx-auto w-full">
        <div className="bg-gradient  flex flex-col items-center justify-start p-[50px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col md:gap-10 gap-[70px] items-center justify-start max-w-[1240px] mb-5 mx-auto w-full">
            <header className="flex items-center justify-center w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-center w-full">
                ...
                <div className="flex md:flex-1 sm:flex-col flex-row font-opensans sm:hidden items-start justify-center md:ml-[0] ml-[107px] pt-0.5 w-[52%] md:w-full">
                  ...
                  <div className="flex flex-col items-center justify-start ml-8 w-auto sm:w-full">
                    <Text
                  ...
                  <div className="flex flex-col items-center justify-start ml-[31px] w-auto sm:w-full">
                    <Text
                      className="common-pointer not-italic text-gray_900_cc text-left w-auto"
                      variant="body6"
                  ...
                  <div className="flex flex-col items-center justify-start ml-[27px] w-auto sm:w-full">
                    <Text
                      className="common-pointer not-italic text-gray_900_cc text-left w-auto"
                      variant="body6"
                ...
                <Button
                  className="cursor-pointer font-semibold sm:hidden leading-[normal] min-w-[112px] md:ml-[0] ml-[25px] text-center text-sm text-white_A700 w-auto"
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
              <div className="flex md:flex-1 flex-col items-center justify-start rounded-[16px] w-auto md:w-full">
                <div className="flex flex-col gap-9 items-start justify-start w-full">
                  <div className="flex flex-col gap-4 items-start justify-start w-full">
                    ...
                    ></Text>
                    <Text
                      className="font-normal font-poppins leading-[200.00%] not-italic text-gray_802 text-left w-[91%] sm:w-full"
                      variant="body2"
                    >
                  ...
                  <div className="flex sm:flex-col flex-row gap-6 items-center justify-start w-[85%] md:w-full">
                    <Button
                      className="common-pointer cursor-pointer font-semibold min-w-[232px] text-center text-white_A700 text-xl w-auto"
                      onClick={() => navigate("/menu")}
                      shape="RoundedBorder16"
                      size="xl"
                      variant="FillRed400"
                    ...
                    <Button
                      className="common-pointer cursor-pointer font-semibold min-w-[232px] text-center text-red_400 text-xl w-auto"
                      onClick={() => navigate("/reservation")}
                      shape="RoundedBorder16"
                      size="xl"
              ...
              <Img
                ...
                className="md:flex-1 h-[502px] sm:h-auto object-cover w-auto md:w-full"
                alt="illustration"
              />
            </div>
          </div>
          ...
          <div className="flex md:flex-col flex-row gap-[13px] items-start justify-start ml-[149px] md:px-5 w-[79%]">
            ...
            <div className="flex flex-col gap-9 items-start justify-start md:mt-0 mt-[91px] rounded-[16px] w-[39%] md:w-full">
              <div className="flex flex-col gap-4 items-start justify-start w-full">
                ...
                ></Text>
                <Text
                  className="font-normal font-poppins leading-[200.00%] not-italic text-gray_801 text-left w-full"
                  variant="body2"
                >
        ...
        <div className="flex flex-col font-opensans md:gap-10 gap-[79px] items-center justify-start max-w-[1112px] mt-[133px] mx-auto md:px-5 w-full">
          <Text className="text-gray_900 text-left w-auto" as="h3" variant="h3">
            Our Popular Menu
          </Text>
          <div className="flex flex-col font-poppins gap-[50px] items-center justify-start w-full">
            <div className="flex sm:flex-col flex-row gap-7 items-center justify-between rounded-[16px] w-full">
              <Button
                className="cursor-pointer font-semibold min-w-[232px] text-center text-white_A700 text-xl w-auto"
                shape="RoundedBorder16"
                size="xl"
                variant="FillRed400"
              >
              ...
              <Button
                className="cursor-pointer font-normal min-w-[192px] not-italic text-center text-gray_900 text-xl w-auto"
                shape="RoundedBorder16"
                size="xl"
                  ...
                  <div className="bg-white_A700 flex flex-1 flex-col gap-6 items-center justify-center p-[30px] sm:px-5 rounded-[40px] w-full">
                    ...
                    <div className="flex flex-col items-center justify-end mb-1.5 pt-[17px] w-full">
                      <div className="flex flex-col gap-[18px] items-center justify-start w-full">
                        ...
                        <Text
                          className="leading-[200.00%] not-italic text-center text-gray_800 w-full"
                          variant="body7"
                        >
                      ...
                      <div className="flex flex-row gap-[34px] items-center justify-between mt-[30px] rounded-lg w-[95%] md:w-full">
                        ...
                        <Button
                          className="common-pointer cursor-pointer font-semibold min-w-[158px] text-base text-center text-white_A700 w-auto"
        ...
        <div className="flex flex-col items-center justify-start max-w-[1112px] mt-[156px] mx-auto md:px-5 w-full">
          ...
          <Button
            className="cursor-pointer font-poppins font-semibold min-w-[235px] mt-[83px] text-center text-white_A700 text-xl w-auto"
            shape="RoundedBorder16"
            size="xl"
            variant="FillRed400"
          >
