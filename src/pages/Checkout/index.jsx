          ...
          <div className="flex flex-col md:gap-10 gap-[100px] items-start justify-start max-w-[1112px] mx-auto md:px-5 w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              ...
              <div className="flex md:flex-1 sm:flex-col flex-row font-opensans sm:gap-5 items-start justify-center md:ml-[0] ml-[107px] md:mt-0 mt-2.5 pt-0.5 w-[52%] md:w-full">
                ...
                <div className="flex flex-col items-center justify-start sm:ml-[0] ml-[27px] w-auto sm:w-full">
                  <Text
                    className="common-pointer not-italic text-gray_900_cc text-left w-auto"
                    variant="body6"
                  ...
                  <div className="flex flex-col font-poppins gap-8 items-center justify-start w-full">
                    <div className="flex flex-col gap-3.5 items-start justify-start rounded-lg w-full">
                      ...
                      <div className="flex sm:flex-col flex-row gap-4 items-center justify-between rounded-lg w-full">
                        ...
                        ></Input>
                        <Button
                          className="common-pointer cursor-pointer font-normal min-w-[166px] not-italic text-center text-lg text-white_A700 w-auto"
                      ...
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex flex-col gap-6 items-center justify-start w-full">
                          <div className="flex sm:flex-col flex-row gap-4 items-center justify-between w-full">
                            <Input
                              wrapClassName="sm:flex-1 w-auto sm:w-full"
                              className="font-normal not-italic p-0 placeholder:text-gray_500 text-base text-gray_500 text-left w-full"
                              type="text"
                              name="Emailaddress"
                          ...
                          <div className="flex md:flex-col flex-row gap-4 items-center justify-between w-full">
                            <div className="bg-white_A700 border border-gray_400 border-solid flex md:flex-1 flex-row gap-4 items-center justify-start p-3 rounded-lg w-auto md:w-full">
                              <SelectBox
                            ...
                            <Input
                              wrapClassName="md:flex-1 w-auto md:w-full"
                              className="font-normal not-italic p-0 placeholder:text-gray_500 text-base text-gray_500 text-left w-full"
                              type="email"
                          ...
                          <TextArea
                            className="font-normal leading-[normal] not-italic text-base placeholder:text-gray_500 text-gray_500 text-left w-full"
                            name="Massage"
                            placeholder="Message"
                            shape="RoundedBorder8"
                            size="md"
                      ...
                      >
                        ...
                        >
                          <Radio
                            ...
                            className="font-normal leading-[normal] not-italic text-gray_900 text-left text-lg"
                          ...
                          <Radio
                            ...
                            className="font-normal leading-[normal] ml-4 not-italic text-gray_900 text-left text-lg"
                            inputClassName="h-6 mr-[5px] w-6"
                            checked={false}
                            name="paymentmethod"
                    ...
                    <Button
                      className="cursor-pointer font-medium min-w-[722px] md:min-w-full text-center text-white_A700 text-xl w-auto"
